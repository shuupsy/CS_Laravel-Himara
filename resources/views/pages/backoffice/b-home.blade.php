...
@section('content')
    <div class="my-6 sm:px-6 lg:px-8">
        ...
        <div class="p-6 border-b grid grid-cols-3 border-gray-200">

            @foreach ($users as $user)
                <div class="p-3 border-b bg-white border-gray-200 flex justify-between items-center">
                    <div class='flex items-center gap-3'>
                        <div class='w-3/12 object-fit'>
                            <img src="/images/users/{{ $user->profile_pic }}" alt="User profile picture" class='rounded-full'>
                        </div>
                        <div>
                            <h2 class='capitalize text-slate-600 text-lg'>{{ $user -> first_name }} {{ $user -> last_name }}</h2>
